""" Main script for creating training data on MAP-MRI for tractography """
...
sr_datageneration.create_training_data(opt, highres_name='h4_all_', lowres_name='h4_all_lowres_2_')
